...
public class LinkedListQuestions {
	...
	public static void main(String args[]) {
		 ...
		 * System.out.println(list.makeCycle(ar.length)); String s =
		 * list.containsCycle() ? "contains cycle" : "No Cycle"; System.out.println(s);
		 * if(list.containsCycle()) { list.firstNodeOfLoop(); }
		 */
		list.reverseList();
		//list.printList();
